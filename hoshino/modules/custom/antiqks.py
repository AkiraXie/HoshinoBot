...
@sv.on_keyword(["granbluefantasy.jp"], normalize=True, event='group',can_private=1)
...
@sv.on_rex(r'https?:\/\/[a-z0-9A-Z\.\-]{4,11}\/[a-zA-Z0-9\-]+', normalize=False, event='group',can_private=1)
